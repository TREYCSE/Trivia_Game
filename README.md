...
features / user stories that you planned during the development phase of the project
Bronze: complete
  responsive self-scoring game where the user is able to test and score their knowledge on the basics of development
...
> DIV containers
> buttons
> text input form to gather input from user (username)
...
CSS was not a highlight of this game yet as functionality through vanilla PHP is the main focus, but there has been good progress made on a esponsive design for mobile, ipad, small desktop, and larger desktop.
...
Issue Tracker: (https://docs.google.com/spreadsheets/d/1h3rOtnA9zg10dT5oqklCbmK6vP9EDftnQArKYl7rBWg/edit#gid=0)
